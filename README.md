# Cloud Project Report: Automated CI/CD Pipeline for a 2-Tier Flask Application on AWS
...
1.  **Launch EC2 Instance:**
    ...
    * Launch a new instance using the **Ubuntu 22.04 LTS**.
...
2.  **Configure the Pipeline:**
    * In the project configuration, to the **Pipeline** section.
